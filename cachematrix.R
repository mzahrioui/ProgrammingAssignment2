## My function will work the same way the functions i the example apart from the fact that 
## I should replace the function "mean" with the function "solve" and rename the
